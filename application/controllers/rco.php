...
class Rco extends CI_Controller{
 ...
 public function __construct(){         
       ...
       public function viewOffence($query_id = 0, $sort_by = 'request_id', $sort_order = 'desc', $offset = 0){
           ...
           //pagination
           $config['base_url'] = base_url().$this->uri->segment(1).'/rco/viewOffence/'.$query_id.'/'.$sort_by.'/'.$sort_order.'/';
    ...
    public function filterOffence(){
       ...
       redirect("rco/viewOffence/$query_id");  
    }
   ...
   public function report_Majorcrime(){
     ...
     ///// end of report /////
       ...
       public function isLoggedIn() {
        ...
        if(!isset($isLoggedIn) || $isLoggedIn != true || $isPosition != 'rco')
             {
            redirect('home');
            die();
             }
