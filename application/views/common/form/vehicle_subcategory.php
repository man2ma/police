...
<label>Aina ya Chombo cha Moto</label>
       <?php 
       $js = 'id="vehicle_categoryid" class="form-control"';
       echo form_dropdown('vehicle_category',$vehicle_categoryid,'large', $js); 
       ?>
</div>
<div class="form-group">
     <label>Maelezo Mengine</label> <br/>
     <textarea class="form-control" id="chasisnumberid" placeholder="Maelezo ya chombo cha moto"></textarea>
...
<?php if(($this->session->userdata('station_typeid'))==1){?>
<div class="form-group">
