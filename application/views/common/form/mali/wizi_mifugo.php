...
<div class="form-group">
    <label>Mifugo iliyopatikana</label>
    <?php 
      echo form_input($itemokolewa_settings);
    ?>
</div>

<div class="form-group">
    <label>Thamani ya mifugo iliyoibiwa</label>
    <?php 
...
<div class="form-group">
    <label>Thamani ya mifugo iliyopatikana</label>
    <?php 
      echo form_input($thamaniokolewa_settings);
    ?>
</div>
