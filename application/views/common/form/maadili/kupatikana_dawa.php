...
<div class="form-group">
    <label>Aina ya dawa</label>
       <?php 
       $js = 'id="aina_dawa" class="form-control"';
       echo form_dropdown('aina',$aina_ya_dawa,'large', $js); 
       ?>
</div>

<div class="form-group" id='dawa_space'></div>
...
<div class="form-group">
    <label>Kiasi</label>
    <?php 
      echo form_input($amount_settings);
    ?>
</div>

<div class="form-group">
    <label>Thamani ya dawa</label>
    <?php 
